...
public class Heo_StageManager_2_2 : MonoBehaviour
{
    [Header("진행 상황")]
    ...
    private void Update()
    {
        ...
        if (stagemanager.smallNum >= 8 && stagemanager.bigNum == 1)
        {
            stagemanager.bigNum++;
            stagemanager.smallNum = 0;
    ...
    public void MonsterSpawn_0()
    {
        ...
        Instantiate(MonsterSangmo, spawnPoint_1[3].position, Quaternion.identity);
        Instantiate(MonsterBuoy, spawnPoint_1[4].position, Quaternion.identity);
        Instantiate(MonsterSangmo, spawnPoint_1[5].position, Quaternion.identity);
        Instantiate(MonsterBow, spawnPoint_1[6].position, Quaternion.identity);
        Instantiate(MonsterBow, spawnPoint_1[7].position, Quaternion.identity);
    ...
    public void MonsterSpawn_1()
    {
        ...
        Instantiate(MonsterBow, spawnPoint_2[2].position, Quaternion.identity);
        Instantiate(MonsterSangmo, spawnPoint_2[3].position, Quaternion.identity);
        Instantiate(MonsterSangmo, spawnPoint_2[4].position, Quaternion.identity);
        Instantiate(MonsterSangmo, spawnPoint_2[5].position, Quaternion.identity);
        Instantiate(MonsterSpear, spawnPoint_2[6].position, Quaternion.identity);
        Instantiate(MonsterSpear, spawnPoint_2[7].position, Quaternion.identity);
    }
